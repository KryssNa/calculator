...
button_mul= Button(root,text="*",padx=31,pady=15, command=button_mul)
button_div= Button(root,text="/",padx=30,pady=15, command=button_div)
button_sub= Button(root,text="-",padx=31,pady=15, command=button_sub)
button_equal= Button(root,text="=", padx=30,pady=15, command=button_equal)
button_clear= Button(root,text="clear",padx=21,pady=15, command= button_clear)
